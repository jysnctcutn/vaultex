...
reported to the project maintainer via [GitHub Security
Advisories](https://github.com/jysnctcutn/vaultex/security/advisories/new)
(private) or via contact information listed on the maintainer's [GitHub
profile](https://github.com/jysnctcutn). All complaints will be reviewed
