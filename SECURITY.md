...
Vaultex is designed as a **local-first, single-operator** tool. See the README's ["Security model"](README.md#security-model) section for the full breakdown; in short:
